...
import { IconCheck, IconClock, IconAlertCircle, IconInfoCircle, IconMaximize } from "@tabler/icons-react";
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-2">
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent className="max-w-4xl min-w-200 max-h-[90vh]">
                <DialogHeader>
                  <div className="flex items-start justify-between">
                    <div>
                      <DialogTitle>Scan Details</DialogTitle>
                      <DialogDescription>ID: {scan.scan_id}</DialogDescription>
                    </div>
